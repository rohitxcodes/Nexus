      ...
      >
        ...
        <div className=" pt-25">
          <div className="train p-10 flex pb-39 pt-20">
            ...
            <p className="text-2xl text-center">
              Ready to level up? Solve interactive challenges, compete with
              friends, and build real skills through fun, game-powered learning.
            </p>
        ...
        <div className="">
          <div className="overview  flex pb-39 pt-20 ">
            <h1 className="text-5xl tracking-widest text-left px-10">
              {" "}
              Overview
            </h1>
            <p className="text-2xl tracking-widest px-10">
              Solve questions alloted to you acc to your level
            </p>
            <img src="image.png" className="w-250 px-10" alt="" />
            <p className="text-2xl tracking-widest px-10">
              These are coins,earn it by solving various questions and also
            ...
            <div className="flex">
              ...
              <div className="flex flex-col gap-10 px-10">
                <p className="text-2xl">
                  +3 coins for every correct question and -1 for every time you
                  give up{" "}
                </p>
                <p className="text-2xl">
                  You can also earn coins by completing various missions and
                  quest{" "}
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-20">
              ...
              <div>
                <p className="text-2xl pt-20">
                  Use your coins to buy power ups and various other boosters
                  which will help you to top the leaderboards
                </p>
              </div>
            </div>
          </div>
